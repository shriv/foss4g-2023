...
I grew up in Vashi, originally conceived as a release valve from the bursting island metropolis of Mumbai (also known as Bombay). Vashi was to be part of a nearby series of satellite townships that would provide affordable housing _".. especially for economically weaker sections, low-income groups and industrial labour"_ @yuvaonlineIndiaLargestPlanned2022. Unfortunately, this spillover area, known collectively as Navi Mumbai, features little of the intended ideology and planning @antonopoulosPrototypingInformalityMass. It features the similar rampant organic urbanism seen in the original island city of Mumbai - well to-do towers and gated communities amidst a mileu of middle-class housing and squat but dense settlements ranging from formal to semi-formal.   

<!-- Connection of well-todo and poor with the above paragraph -->
The housing society where I grew up was a tranquil oasis of townhouses but across the road was a teeming boil of social and economic activity. A jumbled cluster of semi-informal buildings with shop fronts sticking cheek by jowl next to each other. Shops would casually expand their wares out onto the pavement and in the evenings, street vendors set up their portable stalls on any remaining patch of pavement, calling out regularly in nasal staccato voices. 
...
if (!file.exists("./assets/sector-17.jpeg")){
  url <- google_streetview(location = c(19.0717768,73.00001),
                    size = c(400,400),
                    panorama_id = NULL,
                    output = "html",
                    heading = 355,
  ...
  download.file(url, "./assets/sector-17.jpeg", model="wb")  
}
```
::: {layout-ncol=2}
...
Amenities crop up along informal housing as well as well-established apartment buildings in a dizzying array of sizes and flavours in tight, constrained spaces - offering everything from a nursing home, an evening hawker selling roasted nuts, whose entire store is strapped to his front, to a plywood store with a glamorous updo of air conditioning and glossy surfaces. Further into the building you can find other businesses tucked away - tuition centres, hair salons and boutiques taking advantage of the quieter solitude of the building atrium. 
