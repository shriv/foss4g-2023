...
I regularly walk around my neighbourhood of Northland where even a 20 minute walk is a delightful multi-sensory assault. The wind dishevels my hair as I take in the visual panoramas of the city, sea and hills while by being serenaded shrieks of the kaka and the heavy whoosh of a kereru's weighty wings. 
...
![The transport fingerprint of a city: the different ways in which transport modes share street space @nateraExtractingMultimodalFingerprint2020. Figure can be reproduced by anyone using the [open source code published alongside the paper.](./assets/multilayer-multimodal-networks.png)
